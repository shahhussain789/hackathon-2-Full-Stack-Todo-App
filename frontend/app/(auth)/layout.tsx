...
export default function AuthLayout({
  ...
  return (
    <div className="min-h-screen flex">
      {/* Left Side - Branding */}
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-800 p-12 flex-col justify-between">
        <div>
        ...
        <p className="text-indigo-300 text-sm">© 2026 TaskFlow. All rights reserved.</p>
      </div>
